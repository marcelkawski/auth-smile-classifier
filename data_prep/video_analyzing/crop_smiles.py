...
from config import FACES_SAME_LEN_DIR, SMILES_DATA_FILE_PATH, SMILES_DATA_DIR
...
def create_complete_smiles_data_file():
    ...
    lens_values = set(scaled_frames_lens)
    if len(lens_values) == 1 and scaled_frames_lens[0] == min_num_smile_frames:
